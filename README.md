...
**以接线、调电机和控制为工作目标的学员，按[单电机实操路线](PRACTICAL_PATH.md)学习并验收。** 它把基础课接到工位操作：认设备→接线与上电→读反馈→有限运动与停止→调参→交接。每步都有术语解释、预期现象和排错方法；完成基础课后，还需完成实际工位记录才能算具备对应动手能力。
...
| 参与团队机械臂设计、方案比较与交付 | [机械臂设计开发流程](ROBOT_DEVELOPMENT_PATH.md) | 模型版本、工具规划、方案评审与验证证据 |
