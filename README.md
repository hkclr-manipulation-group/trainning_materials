...
面向刚加入团队、需要理解机器人开发全流程的同事。沿用仓库名 `trainning_materials`。本套资料把本体设计、通信、控制、软件工程、感知与 AI 串成一条可以动手走通的路线。

**一周目标：能解释系统、运行离线实验、阅读项目入口、提交一个有测试证据的小改动。** 独立完成机械定型、驱动器调参或真机 AI 部署，需要后续专项训练。

## 从这里开始

1. 阅读 [一周课表](WEEK_PLAN.md)，每天约 6 小时，共 42 小时。
...
| 讲师安排与分层教学 | [INSTRUCTOR_GUIDE.md](INSTRUCTOR_GUIDE.md) |
